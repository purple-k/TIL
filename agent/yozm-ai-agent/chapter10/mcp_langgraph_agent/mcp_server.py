...
def get_kbo_rank() -> str:
    ...
    result = httpx.get("https://sports.daum.net/prx/hermes/api/team/rank.json?leagueCode=kbo&seasonKey=2026")
    return result.text
...
### 오늘자 주요 뉴스
[get_news_headlines의 결과] (링크를 함께 제공합니다)
