...
사용자가 위치한 곳을 안다면 바로 brief_today() 도구의 지침을 따르면 됩니다.
아니라면, 위치를 물어보고 나서 도구의 지침을 따릅니다.
...
async def stream_agent_response(agent_executor, messages: str, session_id: str):
    """에이전트의 응답을 스트리밍하는 비동게 제너레이터."""
