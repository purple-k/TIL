...
def process_message(state: MemoryBotSate) -> dict[str, Any]:
...
def create_memory_bot_graph():
    ...
    workflow = StateGraph(MemoryBotSate)
...
def main():
    ...
    for i, message in enumerate(conversations, 1):
        ...
        print(f"메모리: 이름={result.get('user_name', '없음')}, 좋아하는 것={result.get('user_preferences', {})}\n")
